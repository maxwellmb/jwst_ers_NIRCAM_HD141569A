...
if __name__ == "__main__":
    ...
    # Blur frames.
    # ImageTools.blur_frames(fact=None,
    #                        types=['SCI', 'REF'],
    #                        subdir='blurred')
    ...
    # Extract companions.
    # AnalysisTools.extract_companions(companions=[[1.225, 1.225, 1e-5]],
    #                                  starfile='hip_65426.vot',
    #                                  mstar_err=0.,
    #                                  spectral_type='A2V',
    #                                  klmode='max',
    #                                  date='auto',
    ...
    # AnalysisTools.raw_contrast(starfile='hip_65426.vot',
    #                            spectral_type='A2V',
    #                            companions=[[1.225, 1.225, 8.]],
    #                            subdir='rawcon')
